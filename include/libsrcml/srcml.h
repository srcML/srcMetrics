 ...
 */
LIBSRCML_DECL int srcml_version_number(void);

/**
 * The current version of the library
 * @return Version of libsrcml as a string
 */
LIBSRCML_DECL const char* srcml_version_string(void);
/**@}*/
 ...
 */
LIBSRCML_DECL size_t srcml_get_language_list_size(void);
 ...
 */
LIBSRCML_DECL int srcml_check_xslt(void);
 ...
 * @retval 0 if it is unavailable
 */
LIBSRCML_DECL int srcml_check_exslt(void);
/**@}*/
 ...
 */
LIBSRCML_DECL const char* srcml_error_string(void);
/**@}*/
 ...
 * @retval SRCML_STATUS_OK on success, SRCML_STATUS_INVALID_ARGUMENT otherwise
 */
 ...
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_src_encoding(void);

/**
 * @return The XML encoding on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_xml_encoding(void);

/**
 * @return The srcML revision attribute on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_revision(void);

/**
 * @return The language attribute on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_language(void);

/**
 * @return The filename attribute on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_filename(void);

/**
 * @return The url attribute for the root unit on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_url(void);

/**
 * @return The version attribute on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_version(void);

/**
 * @return The timestamp attribute on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_timestamp(void);

/**
 * @return The hash attribute on success
 * @return NULL on failure
 */
LIBSRCML_DECL const char* srcml_get_hash(void);

/**
 * @return The loc of the source code on success
 * @return -1 on failure
 */
LIBSRCML_DECL int srcml_get_loc(void);

/**
 * @return The eol for to-src output (unparse)
 * @return NULL on failure
 */
LIBSRCML_DECL size_t srcml_get_eol(void);

/**
 * @return The currently set options on success
 * @return NULL on failure
 */
LIBSRCML_DECL int srcml_get_options(void);

/**
 * @return The tabstop size on success
 * @return NULL on failure
 */
LIBSRCML_DECL size_t srcml_get_tabstop(void);

/**
 * @return The processing instruction target
 */
LIBSRCML_DECL const char* srcml_get_processing_instruction_target(void);

/**
 * @return The processing instruction data
 */
LIBSRCML_DECL const char* srcml_get_processing_instruction_data(void);
/**@}*/
 ...
 */
LIBSRCML_DECL size_t srcml_get_namespace_size(void);
 ...
 */
LIBSRCML_DECL void srcml_cleanup_globals(void);
/**@}*/
 ...
 * @note Archive must be freed using srcml_archive_free(void)
 * @return The created srcml_archive
 */
LIBSRCML_DECL struct srcml_archive* srcml_archive_create(void);
 ...
 * @retval SRCML_STATUS_OK on success, SRCML_STATUS_IO_ERROR otherwise
 */
 ...
 * @param result Optional struct of different results types
...
/**
 * @param result A srcml transformation result
 * @param index The index in the units
 ...
 */
LIBSRCML_DECL size_t srcml_get_srcdiff_revision(void);
